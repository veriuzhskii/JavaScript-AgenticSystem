    ...
    def _get_instruction(self, agent_name: str) -> str:
        instructions = {
            ...
            "teacher": (
                ...
                "6) Собирать обатную связь: уточняй понятны ли объяснения, нужны ли примеры/аналогии, нужно ли задание по теме?"
                "Не выделей обратную связь отдельным заголовком.\n"
            ...
            "coder": (
                ...
                "Верни только JSON строго по схеме:"
                "{\n"
                '  "fixed_code:" "запиши сюда исправленный вариант кода. Оставь это поле пустым, если в коде не было ошибок",\n'
                '  "comment:" "запиши сюда комментарий по исправлению кода. Оставь это поле пустым, если в коде не было ошибок",\n'
